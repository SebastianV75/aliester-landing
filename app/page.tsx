...
export default function Home() {
	return (
		<main className="flex flex-col">
			...
			<nav
				id="site-nav"
				className="nav-blur fixed top-0 right-0 left-0 z-50 border-b border-[var(--border)]"
			>
			...
			<section className="relative flex min-h-screen flex-col items-center justify-center px-6 pt-24 pb-16 text-center">
				...
				<h1 className="rise rise-2 max-w-5xl text-5xl leading-[1.08] font-bold tracking-tight sm:text-6xl lg:text-7xl">
					...
					<span className="text-[var(--fg-muted)]">
						antes de que el caos decida por ti
					</span>
				</h1>

				<p className="rise rise-3 mt-8 max-w-2xl text-lg leading-relaxed text-[var(--fg-muted)]">
					Aliester analiza tu contexto completo — tareas, dinero, calendario,
					notas y suscripciones — y te muestra primero lo que merece atención
					ahora, lo que sigue después y lo que puede esperar.
				</p>
						...
						<div className="screenshot-toolbar mb-3 flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--bg)] px-4 py-3">
							<div className="text-left">
								<p className="text-sm font-semibold text-[var(--fg)]">
									Asistente y centro de atención
								</p>
								<p className="text-xs text-[var(--fg-dim)]">
									Prioridades, contexto y siguientes pasos en una sola vista
								</p>
							</div>
				...
				<div className="mx-auto max-w-6xl">
					<div className="mx-auto max-w-2xl text-center">
						...
						<h2 className="text-4xl font-bold tracking-tight text-[var(--fg)] lg:text-5xl">
							...
							<br />
							<span className="text-[var(--fg-muted)]">
								cuando prioriza por ti
							</span>
						</h2>
						<p className="mt-6 text-lg leading-relaxed text-[var(--fg-muted)]">
							Esta vista aterriza la promesa del producto: menos ruido, más
							claridad y una siguiente acción concreta basada en tu contexto
							real.
						</p>
					</div>

					<div className="group relative mx-auto mt-16 max-w-3xl lg:mt-20">
						<div className="accent-glow overflow-hidden rounded-2xl border border-[var(--border-strong)] bg-[var(--bg-elevated)]">
							...
							<div className="space-y-5 p-6 lg:p-8">
								<p className="text-sm leading-relaxed text-[var(--fg-muted)] lg:text-base">
									En lugar de prometer una IA abstracta, aquí está el centro de
									atención real del producto: prioridades, siguientes pasos y
									contexto en una sola vista.
								</p>
								...
								<div className="flex items-center gap-2 text-xs text-[var(--fg-dim)]">
									...
									<span>
										Prioridades generadas sobre datos reales del producto
									</span>
								</div>
							</div>
						</div>
				...
				<div className="mx-auto max-w-6xl">
					<div className="grid gap-16 lg:grid-cols-12 lg:gap-12">
						...
						<div className="lg:col-span-5 lg:sticky lg:top-28 lg:self-start">
							...
							<p className="mt-6 text-lg leading-relaxed text-[var(--fg-muted)]">
								No te desorganizas por falta de herramientas — te desorganizas
								porque cada área de tu vida vive en una app distinta.
							</p>
						</div>
							...
							{[
								{
									...
									description:
										"Revisas tu saldo, pero no ves el panorama completo",
								},
								{
									icon: Calendar,
								...
								},
								{
									...
									description:
										"Cobros sorpresa que descubres cuando ya es tarde",
								},
							].map((item) => (
								<div
									key={item.title}
									className="card-surface flex gap-4 rounded-xl p-5"
								>
			...
			<section
				id="features"
				className="section-border px-6 py-16 sm:py-24 lg:py-32"
			>
				<div className="mx-auto max-w-6xl">
					<div className="mx-auto max-w-2xl text-center">
						<div className="badge badge-accent mb-6">
						...
						<p className="mt-6 text-lg leading-relaxed text-[var(--fg-muted)]">
							Aliester reúne todas las áreas de tu vida en un panel unificado.
							Sin cambiar de apps, sin configurar integraciones complejas.
						</p>
					</div>
					...
					<div className="mt-16 grid gap-3 md:grid-cols-3 lg:mt-20">
						...
						<div className="card-surface group rounded-xl p-6 md:col-span-2 md:p-8">
							...
							<p className="mt-2 max-w-md text-sm leading-relaxed text-[var(--fg-muted)]">
								Vista panorámica: balance del mes, tareas urgentes, próximos
								eventos, gasto en suscripciones. Todo de un vistazo.
							</p>
						...
						<div className="card-surface group rounded-xl p-6">
							...
							<p className="mt-2 text-sm leading-relaxed text-[var(--fg-muted)]">
								Registro de ingresos y gastos por categoría, vinculados a
								cuentas bancarias
							</p>
						</div>
						...
						<div className="card-surface group rounded-xl p-6">
							...
							<p className="mt-2 text-sm leading-relaxed text-[var(--fg-muted)]">
								Proyectos con tareas, prioridades y estados en un kanban
								simplificado
							</p>
						</div>
						...
						<div className="card-surface group rounded-xl p-6">
							...
							<p className="mt-2 text-sm leading-relaxed text-[var(--fg-muted)]">
								Ideas y apuntes con fecha, siempre accesibles desde cualquier
								vista
							</p>
						</div>
						...
						<div className="card-surface group rounded-xl p-6 md:col-span-2 md:p-8">
							<div className="flex items-start gap-5">
								...
								<div>
									...
									<p className="mt-2 text-sm leading-relaxed text-[var(--fg-muted)]">
										Servicios activos con costo, fecha de corte y cuenta
										asociada. Alertas antes del cobro para que nada te tome por
										sorpresa.
									</p>
								</div>
							</div>
						...
						{[
							{
								...
								title: "Freelancers",
								description:
									"Manejas proyectos, clientes, facturas y deadlines. Necesitas ver todo sin cambiar de herramienta cada 5 minutos.",
								features: [
							...
							},
							{
								...
								title: "Emprendedores",
								description:
									"Tu negocio y tu vida personal comparten el mismo cerebro. Necesitas una herramienta que entienda eso.",
								features: [
							...
							},
							{
								...
								description:
									"Clases, proyectos paralelos, gastos limitados. Necesitas claridad sin complejidad.",
								features: [
			...
			<section
				id="cta"
				className="section-border relative px-6 py-16 sm:py-24 lg:py-32"
			>
					...
					<div className="gradient-border rounded-3xl bg-[var(--bg-elevated)] px-8 py-16 text-center lg:px-16 lg:py-20">
						<h2 className="text-4xl font-bold tracking-tight text-[var(--fg)] sm:text-5xl">
							...
							<span className="gradient-text">
								Empieza a decidir con claridad.
							</span>
						</h2>
						<p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-[var(--fg-muted)]">
							Un solo lugar para todo. Un asistente que piensa por ti. Cero
